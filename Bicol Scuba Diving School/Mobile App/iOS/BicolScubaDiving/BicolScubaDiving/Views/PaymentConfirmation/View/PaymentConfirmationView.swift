...
final class PaymentConfirmationView: UIView {
    
    private let logoImageView: UIImageView = {
        let imageView = UIImageView()
        imageView.image = UIImage(named: AppConstant.PaymentConfirmation.logo)
    ...
    private let headerLabel: UILabel = {
        let label = UILabel()
        label.text = AppConstant.PaymentConfirmation.bookingHeader
    ...
    private let thankYouLabel: UILabel = {
        let label = UILabel()
        label.text = AppConstant.PaymentConfirmation.thankYouLabel
    ...
    private let detailsLabel: UILabel = {
        let label = UILabel()
        label.text = AppConstant.PaymentConfirmation.details
        label.font = UIFont.roboto(.medium, size: 18)
        label.textColor = .primaryBlueColor
        label.textAlignment = .center
    ...
    let homeButton: CustomButton = {
        ...
        button.setTitle(AppConstant.PaymentConfirmation.homeButtonTitle, for: .normal)
